...
export function Footer() {
  const footerLinks = {
    ...
    "For Vendors": [
      {
        name: "Vendor Portal",
        href: "https://errandsorthub.errandsort.com/vendor/login/",
      },
    ],
        ...
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mb-6 text-gray-400">
              Your trusted platform for shopping, selling, and delivering. Join
              thousands of satisfied users today.
            </p>

            <p className="mb-6 text-sm text-gray-400 italic">
              All our apps are available via Web App, Google Play Store, and App
              Store.
            </p>
